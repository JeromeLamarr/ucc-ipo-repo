-- IMMEDIATE FIX: Run this in your Supabase SQL Editor to fix user creation on email verification
-- This creates the missing user records and sets up automatic creation for future registrations
...
-- Step 3: Create user records for any existing verified users without user records
INSERT INTO public.users (
  auth_user_id,
  email,
  full_name,
