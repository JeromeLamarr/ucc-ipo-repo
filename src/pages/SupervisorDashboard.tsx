  ...
  const handleSubmitReview = async () => {
    ...
    try {
      ...
      if (applicantEmail) {
        ...
        console.warn('[SupervisorDashboard] Could not send email: applicant email not found', {
              ...
              <div key={record.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-4 border-t border-gray-200">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition-colors w-full sm:w-auto"
                  >
