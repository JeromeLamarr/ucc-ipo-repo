  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle="Manage deleted records. Restore records or permanently delete them."
      />
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
        />
      </div>
                ...
                {paginatedDeletedWorkflow.length === 0 ? (
                  ...
                  paginatedDeletedWorkflow.map((record) => (
                    <tr key={record.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <StatusPill status={record.status as string} size="sm" />
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
