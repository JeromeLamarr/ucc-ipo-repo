            ...
            <div key={dept.id} className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
              ...
              <div className="flex gap-2 pt-1">
                <button
                  onClick={() => startEdit(dept)}
                  disabled={loading}
                  className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm border border-blue-200 text-blue-600 rounded-lg hover:bg-blue-50 transition disabled:opacity-50"
                >
                  <Edit2 size={16} />
                  Edit
                </button>
                <button
                  onClick={() => handleDelete(dept.id)}
                  disabled={loading}
                  className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition disabled:opacity-50"
                >
                  <Trash2 size={16} />
                  Delete
                </button>
