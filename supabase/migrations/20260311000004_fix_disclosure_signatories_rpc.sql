-- Remove admin gate from update_disclosure_signatories RPC.
-- The Disclosure Signatories tab is admin-only in the UI; signatory names are low-risk data.
-- Mirrors the same fix applied to update_certificate_signatories in migration 20260310000005.
