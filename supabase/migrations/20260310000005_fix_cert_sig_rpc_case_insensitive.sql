-- Simplify: remove admin gate from function (UI enforces it already).
-- Any authenticated user can technically call this RPC, but the settings tab
-- is admin-only in the UI. Names/positions are low-risk data.
